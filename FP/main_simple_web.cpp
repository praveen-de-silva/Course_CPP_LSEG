 ...
 *   - SimpleWebServer:  Serves UI and provides REST API
 */

#include "CSVReader.h"
#include "Exchange.h"
#include "CSVWriter.h"
#include "web/server/SimpleWebServer.h"
#include <iostream>
#include <vector>
#include <string>
...
int runWebMode()
{
    ...
    try
    {
        ...
        SimpleWebServer server(&exchange, 8080);
        ...
        std::cout << "\n=== SERVER STARTING ===\n"
                  ...
                  << "Note: This is a blocking server. Press Ctrl+C to stop.\n" << std::endl;
